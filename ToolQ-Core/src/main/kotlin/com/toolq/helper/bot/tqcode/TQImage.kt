...
class TQImage private constructor() : TQValue() {
    var md5 : String = ""
    var url : String = ""
    ...
    fun getPicUrl() : String = "http://gchat.qpic.cn/gchatpic_new/0/0-0-${md5.toUpperCase()}/0"
    ...
    override fun isImage(): Boolean = true
