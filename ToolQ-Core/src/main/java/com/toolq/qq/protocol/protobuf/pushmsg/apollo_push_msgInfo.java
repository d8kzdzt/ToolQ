...
public final class apollo_push_msgInfo {
    public static final class STPushMsgElem extends MessageMicro<STPushMsgElem> {
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 90, 98, 106, 114}, new String[]{"type", "showPlace", "priority", "pm1", "pm2", "pm3", "pm4"}, new Object[]{0, 0, 0, null, null, null, null}, STPushMsgElem.class);
